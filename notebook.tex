...
\textbf{As Motivate Employee}: - Identify the most used routes or
location, so Motivate can make more bikes/docking station available in
such area - Identify less used/idle bikes available in the city, this
will help the company to move them to busy location and maximize the
utilization - Identify the different age group of the bike share user,
so different categories(for eg. Kids, Adult) of bikes can be made
available for the user

\textbf{As Motivate User}: - How close is Motivate docking station
available to my location, and is it close enough to my destination - How
easy(with minimal steps) will be my experience from renting a bike via
website/mobile app - Will I get immediate assistance if I get stuck with
the rental process or any issue with the bike
...
{\color{incolor}In [{\color{incolor}32}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} import all necessary packages and functions.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}33}]:} \PY{k}{def} \PY{n+nf}{print\PYZus{}first\PYZus{}point}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
...
below to address each of the cleaning tasks described above.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}34}]:} \PY{k}{def} \PY{n+nf}{duration\PYZus{}in\PYZus{}mins}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 \PY{n}{duration} \PY{o}{=} \PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (ms)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)} \PY{o}{/} \PY{l+m+mi}{1000}\PY{p}{)} \PY{o}{/} \PY{l+m+mi}{60}  \PY{c+c1}{\PYZsh{} convert ms to second and then to minute}
             \PY{k}{else}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}35}]:} \PY{k}{def} \PY{n+nf}{time\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    Takes as input a dictionary containing info about a single trip (datum) and}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 \PY{n}{date\PYZus{}time} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{starttime}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{S}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}        
             \PY{k}{elif} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}        
                 \PY{n}{date\PYZus{}time} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Start date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{k}{else}\PY{p}{:}
                 \PY{n}{date\PYZus{}time} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{starttime}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}        
             
             \PY{k}{return} \PY{p}{(}\PY{n}{date\PYZus{}time}\PY{o}{.}\PY{n}{month}\PY{p}{,} \PY{n}{date\PYZus{}time}\PY{o}{.}\PY{n}{hour}\PY{p}{,} \PY{n}{date\PYZus{}time}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{A}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}36}]:} \PY{k}{def} \PY{n+nf}{type\PYZus{}of\PYZus{}user}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    Takes as input a dictionary containing info about a single trip (datum) and}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
             \PY{n}{customer\PYZus{}type} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Registered}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Casual}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{\PYZcb{}} \PY{c+c1}{\PYZsh{} defind customer mapping for washington}
             
             \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 \PY{n}{user\PYZus{}type} \PY{o}{=} \PY{n}{customer\PYZus{}type}\PY{p}{[}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Member Type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{]} \PY{c+c1}{\PYZsh{} convert Washington customer type to standard type}
             \PY{k}{else}\PY{p}{:}
...
be consistent with the example file.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}37}]:} \PY{k}{def} \PY{n+nf}{condense\PYZus{}data}\PY{p}{(}\PY{n}{in\PYZus{}file}\PY{p}{,} \PY{n}{out\PYZus{}file}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}38}]:} \PY{c+c1}{\PYZsh{} Run this cell to check your work}
...
\textbf{Answer}: - \textbf{Highest Number of trip:} NYC -
\textbf{Highest Number of trip made by Customers:} NYC - \textbf{Highest
Number of trip made by Subscribers:} NYC

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}39}]:} \PY{k}{def} \PY{n+nf}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}40}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Modify this and the previous cell to answer Question 4a. Remember to run \PYZsh{}\PYZsh{}}
         \PY{c+c1}{\PYZsh{}\PYZsh{} the function on the cleaned data files you created from Question 3.      \PYZsh{}\PYZsh{}}
         \PY{n}{total\PYZus{}trips} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
         \PY{n}{subscribers\PYZus{}trips} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
         \PY{n}{customers\PYZus{}trips} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
         
         \PY{n}{trip\PYZus{}city\PYZus{}info} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{\PYZcb{}}\PY{p}{,}
                      \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{\PYZcb{}}\PY{p}{,}
                      \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{\PYZcb{}}\PY{p}{\PYZcb{}}
         
         \PY{c+c1}{\PYZsh{} find total\PYZus{}trips, subscribers\PYZus{}trips and customers\PYZus{}trips for each city}
         \PY{k}{for} \PY{n}{t\PYZus{}city}\PY{p}{,} \PY{n}{t\PYZus{}filenames} \PY{o+ow}{in} \PY{n}{trip\PYZus{}city\PYZus{}info}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
             \PY{n}{subcribers\PYZus{}t}\PY{p}{,} \PY{n}{customers\PYZus{}t}\PY{p}{,} \PY{n}{total\PYZus{}t} \PY{o}{=} \PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{t\PYZus{}filenames}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
             \PY{n}{total\PYZus{}trips}\PY{p}{[}\PY{n}{t\PYZus{}city}\PY{p}{]} \PY{o}{=} \PY{n}{total\PYZus{}t}
             \PY{n}{subscribers\PYZus{}trips}\PY{p}{[}\PY{n}{t\PYZus{}city}\PY{p}{]} \PY{o}{=} \PY{n}{subcribers\PYZus{}t}
             \PY{n}{customers\PYZus{}trips}\PY{p}{[}\PY{n}{t\PYZus{}city}\PY{p}{]} \PY{o}{=} \PY{n}{customers\PYZus{}t}
             
         \PY{c+c1}{\PYZsh{} print max trip, max subscriber trip and max customer trip}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Highest Number of trip:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n+nb}{max}\PY{p}{(}\PY{n}{total\PYZus{}trips}\PY{p}{,} \PY{n}{key}\PY{o}{=}\PY{n}{total\PYZus{}trips}\PY{o}{.}\PY{n}{get}\PY{p}{)}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Highest Number of trip made by Customers:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n+nb}{max}\PY{p}{(}\PY{n}{customers\PYZus{}trips}\PY{p}{,} \PY{n}{key}\PY{o}{=}\PY{n}{customers\PYZus{}trips}\PY{o}{.}\PY{n}{get}\PY{p}{)}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Highest Number of trip made by Subscribers:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n+nb}{max}\PY{p}{(}\PY{n}{subscribers\PYZus{}trips}\PY{p}{,} \PY{n}{key}\PY{o}{=}\PY{n}{subscribers\PYZus{}trips}\PY{o}{.}\PY{n}{get}\PY{p}{)}\PY{p}{)}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
Highest Number of trip:NYC
Highest Number of trip made by Customers:NYC
Highest Number of trip made by Subscribers:NYC
...
\textbf{Answer}: - \textbf{Washington} Average duration:\textbf{18} and
\textbf{10.8\%} trips longer than 30 min. - \textbf{Chicago} Average
duration:\textbf{16} and \textbf{8.3\%} trips longer than 30 min. -
\textbf{NYC} Average duration:\textbf{15} and \textbf{7.3\%} trips
longer than 30 min.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}41}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4b.                 \PYZsh{}\PYZsh{}}
         ...
         \PY{k}{def} \PY{n+nf}{trip\PYZus{}city\PYZus{}duration}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    This function reads in a file with trip data and reports the sum of}
         \PY{l+s+sd}{    trip duration made, and the number of trips longer than 30 min.}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 \PY{c+c1}{\PYZsh{} set up csv reader object}
                 \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                 ...
                 \PY{c+c1}{\PYZsh{} initialize count variables}
                 \PY{n}{total\PYZus{}duration} \PY{o}{=} \PY{l+m+mf}{0.0}
                 \PY{n}{subscriber\PYZus{}duration} \PY{o}{=} \PY{l+m+mf}{0.0}
                 \PY{n}{customer\PYZus{}duration} \PY{o}{=} \PY{l+m+mf}{0.0}
                 \PY{n}{longer\PYZus{}trip} \PY{o}{=} \PY{l+m+mi}{0}
                 \PY{n}{all\PYZus{}trip\PYZus{}list} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                 \PY{n}{subscriber\PYZus{}trip\PYZus{}list} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                 \PY{n}{customer\PYZus{}trip\PYZus{}list} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                 
                 \PY{c+c1}{\PYZsh{} get the total duration and total duration more than 30 min}
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{n}{f\PYZus{}duration} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                     \PY{n}{all\PYZus{}trip\PYZus{}list}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{f\PYZus{}duration}\PY{p}{)} \PY{c+c1}{\PYZsh{} capture the list of all trip}
                     \PY{c+c1}{\PYZsh{}check for customer/subscriber and sum the duration}
                     \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                         \PY{n}{subscriber\PYZus{}duration} \PY{o}{+}\PY{o}{=} \PY{n}{f\PYZus{}duration}
                         \PY{n}{subscriber\PYZus{}trip\PYZus{}list}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}0:.2f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{f\PYZus{}duration}\PY{p}{)}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{} append the list of subscriber trip}
                     \PY{k}{else}\PY{p}{:}
                         \PY{n}{customer\PYZus{}duration} \PY{o}{+}\PY{o}{=} \PY{n}{f\PYZus{}duration}
                         \PY{n}{customer\PYZus{}trip\PYZus{}list}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}0:.2f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{f\PYZus{}duration}\PY{p}{)}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{} append the list of customer trip}
                     
                     \PY{c+c1}{\PYZsh{}increment longer\PYZus{}trip if the trip duration is more than 30 min}
                     \PY{k}{if} \PY{n}{f\PYZus{}duration} \PY{o}{\PYZgt{}} \PY{l+m+mi}{30}\PY{p}{:}
                         \PY{n}{longer\PYZus{}trip} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                     \PY{n}{total\PYZus{}duration} \PY{o}{+}\PY{o}{=} \PY{n}{f\PYZus{}duration}
                                 
                 
                 \PY{c+c1}{\PYZsh{} return as a tuple}
                 \PY{k}{return}\PY{p}{(}\PY{n}{total\PYZus{}duration}\PY{p}{,} \PY{n}{longer\PYZus{}trip}\PY{p}{,} \PY{n}{subscriber\PYZus{}duration}\PY{p}{,} \PY{n}{customer\PYZus{}duration}\PY{p}{,} \PY{n}{all\PYZus{}trip\PYZus{}list}\PY{p}{,} \PY{n}{subscriber\PYZus{}trip\PYZus{}list}\PY{p}{,} \PY{n}{customer\PYZus{}trip\PYZus{}list}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{c+c1}{\PYZsh{} test the above code by passing each city data to }
         
         \PY{n}{trip\PYZus{}city\PYZus{}time} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{\PYZcb{}}\PY{p}{,}
                      \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{\PYZcb{}}\PY{p}{,}
                      \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{\PYZcb{}}\PY{p}{\PYZcb{}}
         
         \PY{k}{for} \PY{n}{time\PYZus{}city}\PY{p}{,} \PY{n}{time\PYZus{}filenames} \PY{o+ow}{in} \PY{n}{trip\PYZus{}city\PYZus{}time}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}    
             \PY{n}{subcribers\PYZus{}t}\PY{p}{,} \PY{n}{customers\PYZus{}t}\PY{p}{,} \PY{n}{total\PYZus{}t} \PY{o}{=} \PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{time\PYZus{}filenames}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
             \PY{n}{t\PYZus{}duration}\PY{p}{,} \PY{n}{l\PYZus{}trip}\PY{p}{,} \PY{n}{d\PYZus{}subscriber}\PY{p}{,} \PY{n}{d\PYZus{}customer}\PY{p}{,} \PY{n}{all\PYZus{}trip\PYZus{}list}\PY{p}{,} \PY{n}{subscriber\PYZus{}trip\PYZus{}list}\PY{p}{,} \PY{n}{customer\PYZus{}trip\PYZus{}list}\PY{o}{=} \PY{n}{trip\PYZus{}city\PYZus{}duration}\PY{p}{(}\PY{n}{time\PYZus{}filenames}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
             \PY{n}{average\PYZus{}duration} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{t\PYZus{}duration} \PY{o}{/} \PY{n}{total\PYZus{}t}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ Average duration:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ and }\PY{l+s+si}{\PYZob{}:0.1f\PYZcb{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{ trips longer than 30 min.}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{time\PYZus{}city}\PY{p}{,} \PY{n}{average\PYZus{}duration}\PY{p}{,} \PY{p}{(}\PY{n}{l\PYZus{}trip} \PY{o}{/} \PY{n}{total\PYZus{}t}\PY{p}{)} \PY{o}{*} \PY{l+m+mi}{100}\PY{p}{)}\PY{p}{)}    
\end{Verbatim}
...
\textbf{Answer}: - \textbf{Washington} Subscriber trip duration is
\textbf{12.5} minutes and the average Customer trip duration is
\textbf{41.7} minutes. - \textbf{Chicago} Subscriber trip duration is
\textbf{12.1} minutes and the average Customer trip duration is
\textbf{31.0} minutes. - \textbf{NYC} Subscriber trip duration is
\textbf{13.7} minutes and the average Customer trip duration is
\textbf{32.8} minutes.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}43}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4c. If you have    \PYZsh{}\PYZsh{}}
         ...
         \PY{k}{for} \PY{n}{time\PYZus{}city}\PY{p}{,} \PY{n}{time\PYZus{}filenames} \PY{o+ow}{in} \PY{n}{trip\PYZus{}city\PYZus{}time}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
             \PY{n}{subcribers\PYZus{}t}\PY{p}{,} \PY{n}{customers\PYZus{}t}\PY{p}{,} \PY{n}{total\PYZus{}t} \PY{o}{=} \PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{time\PYZus{}filenames}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
             \PY{n}{t\PYZus{}duration}\PY{p}{,} \PY{n}{l\PYZus{}trip}\PY{p}{,} \PY{n}{d\PYZus{}subscriber}\PY{p}{,} \PY{n}{d\PYZus{}customer}\PY{p}{,} \PY{n}{all\PYZus{}trip\PYZus{}list}\PY{p}{,} \PY{n}{subscriber\PYZus{}trip\PYZus{}list}\PY{p}{,} \PY{n}{customer\PYZus{}trip\PYZus{}list} \PY{o}{=} \PY{n}{trip\PYZus{}city\PYZus{}duration}\PY{p}{(}\PY{n}{time\PYZus{}filenames}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
             \PY{n}{subscriber\PYZus{}average} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{d\PYZus{}subscriber} \PY{o}{/} \PY{n}{subcribers\PYZus{}t}\PY{p}{)}
             \PY{n}{customer\PYZus{}average} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{d\PYZus{}customer} \PY{o}{/} \PY{n}{customers\PYZus{}t}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ Subscriber trip duration is }\PY{l+s+si}{\PYZob{}:0.1f\PYZcb{}}\PY{l+s+s2}{ minutes and the average Customer trip duration is }\PY{l+s+si}{\PYZob{}:0.1f\PYZcb{}}\PY{l+s+s2}{ minutes.}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{time\PYZus{}city}\PY{p}{,} \PY{n}{subscriber\PYZus{}average}\PY{p}{,} \PY{n}{customer\PYZus{}average}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
library and to generate an example plot.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}44}]:} \PY{c+c1}{\PYZsh{} load library}
...
and Customers for now: just collect all of the trip times and plot them.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}45}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to collect all of the trip times as a list \PYZsh{}\PYZsh{}}
         \PY{c+c1}{\PYZsh{}\PYZsh{} and then use pyplot functions to generate a histogram of trip times.     \PYZsh{}\PYZsh{}}
         \PY{o}{\PYZpc{}}\PY{k}{matplotlib} inline 
         
         \PY{n}{trip\PYZus{}city\PYZus{}time} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{\PYZcb{}}\PY{p}{\PYZcb{}}
         \PY{c+c1}{\PYZsh{} get all trip data and plot it to hist}
         \PY{k}{for} \PY{n}{time\PYZus{}city}\PY{p}{,} \PY{n}{time\PYZus{}filenames} \PY{o+ow}{in} \PY{n}{trip\PYZus{}city\PYZus{}time}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
             \PY{n}{t\PYZus{}duration}\PY{p}{,} \PY{n}{l\PYZus{}trip}\PY{p}{,} \PY{n}{d\PYZus{}subscriber}\PY{p}{,} \PY{n}{d\PYZus{}customer}\PY{p}{,} \PY{n}{all\PYZus{}trip\PYZus{}list}\PY{p}{,} \PY{n}{subscriber\PYZus{}trip\PYZus{}list}\PY{p}{,} \PY{n}{customer\PYZus{}trip\PYZus{}list} \PY{o}{=} \PY{n}{trip\PYZus{}city\PYZus{}duration}\PY{p}{(}\PY{n}{time\PYZus{}filenames}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
             
             \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{all\PYZus{}trip\PYZus{}list}\PY{p}{)} \PY{c+c1}{\PYZsh{} hist with all trip data   }
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Trip Durations for }\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{n}{time\PYZus{}city}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: - Peak of \textbf{All trip} in NYC : \textbf{96660.0}
and max duration : \textbf{7.5}. Average peak use is around 10 mins and
less number of hire for longer duration - Peak of \textbf{All
subscriber} trip in NYC : \textbf{90316.0} and max duration :
\textbf{7.5}. Average peak use is around 10 mins and similar to All
trips there are less number of hire for longer duration - Peak of
\textbf{All Customer} trip in NYC : \textbf{8066.0} and max duration :
\textbf{15.0}. Average peak use is around 15 to 20 mins and reduces
further when duration increases
...
{\color{incolor}In [{\color{incolor}46}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 5. \PYZsh{}\PYZsh{}}
         ...
         \PY{n}{trip\PYZus{}city\PYZus{}time} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{\PYZcb{}}\PY{p}{\PYZcb{}}
         \PY{c+c1}{\PYZsh{} get subscriber and customer trip data and plot to hist}
         \PY{k}{for} \PY{n}{time\PYZus{}city}\PY{p}{,} \PY{n}{time\PYZus{}filenames} \PY{o+ow}{in} \PY{n}{trip\PYZus{}city\PYZus{}time}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}    
             \PY{n}{t\PYZus{}duration}\PY{p}{,} \PY{n}{l\PYZus{}trip}\PY{p}{,} \PY{n}{d\PYZus{}subscriber}\PY{p}{,} \PY{n}{d\PYZus{}customer}\PY{p}{,} \PY{n}{all\PYZus{}trip\PYZus{}list}\PY{p}{,} \PY{n}{subscriber\PYZus{}trip\PYZus{}list}\PY{p}{,} \PY{n}{customer\PYZus{}trip\PYZus{}list} \PY{o}{=} \PY{n}{trip\PYZus{}city\PYZus{}duration}\PY{p}{(}\PY{n}{time\PYZus{}filenames}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
             
             
             \PY{c+c1}{\PYZsh{}plt.hist(all\PYZus{}trip\PYZus{}list) \PYZsh{} hist with all trip data}
             \PY{c+c1}{\PYZsh{}plt.hist(subscriber\PYZus{}trip\PYZus{}list) \PYZsh{} hist with subscriber trip data}
             \PY{c+c1}{\PYZsh{} for all trip}
             \PY{n}{x\PYZus{}val}\PY{p}{,} \PY{n}{y\PYZus{}val}\PY{p}{,} \PY{n}{\PYZus{}} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{all\PYZus{}trip\PYZus{}list}\PY{p}{,} \PY{n+nb}{range}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{75}\PY{p}{]}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{75}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of All Trip Durations for }\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{n}{time\PYZus{}city}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
             
             \PY{n}{bin\PYZus{}max} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{where}\PY{p}{(}\PY{n}{x\PYZus{}val} \PY{o}{==} \PY{n+nb}{max}\PY{p}{(}\PY{n}{x\PYZus{}val}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{} get the duration for peak usage}
             
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Peak of All trip in }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ : }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ and max duration : }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{time\PYZus{}city}\PY{p}{,} \PY{n+nb}{max}\PY{p}{(}\PY{n}{x\PYZus{}val}\PY{p}{)}\PY{p}{,} \PY{n}{y\PYZus{}val}\PY{p}{[}\PY{n}{bin\PYZus{}max}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}
             
             \PY{c+c1}{\PYZsh{} for subscriber trip}
             \PY{n}{x\PYZus{}val}\PY{p}{,} \PY{n}{y\PYZus{}val}\PY{p}{,} \PY{n}{\PYZus{}} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{subscriber\PYZus{}trip\PYZus{}list}\PY{p}{,} \PY{n+nb}{range}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{75}\PY{p}{]}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{75}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Subscriber Trip Durations for }\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{n}{time\PYZus{}city}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
             
             \PY{n}{bin\PYZus{}max} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{where}\PY{p}{(}\PY{n}{x\PYZus{}val} \PY{o}{==} \PY{n+nb}{max}\PY{p}{(}\PY{n}{x\PYZus{}val}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{} get the duration for peak usage}
             
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Peak of All subscriber trip in }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ : }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ and max duration : }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{time\PYZus{}city}\PY{p}{,} \PY{n+nb}{max}\PY{p}{(}\PY{n}{x\PYZus{}val}\PY{p}{)}\PY{p}{,} \PY{n}{y\PYZus{}val}\PY{p}{[}\PY{n}{bin\PYZus{}max}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}
             
             \PY{c+c1}{\PYZsh{} for customer trip}
             \PY{n}{x\PYZus{}val}\PY{p}{,} \PY{n}{y\PYZus{}val}\PY{p}{,} \PY{n}{\PYZus{}} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{customer\PYZus{}trip\PYZus{}list}\PY{p}{,} \PY{n+nb}{range}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{75}\PY{p}{]}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{75}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Customer Trip Durations for }\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{n}{time\PYZus{}city}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
             
             \PY{n}{bin\PYZus{}max} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{where}\PY{p}{(}\PY{n}{x\PYZus{}val} \PY{o}{==} \PY{n+nb}{max}\PY{p}{(}\PY{n}{x\PYZus{}val}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{} get the duration for peak usage}
             
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Peak of All Customer trip in }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ : }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ and max duration : }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{time\PYZus{}city}\PY{p}{,} \PY{n+nb}{max}\PY{p}{(}\PY{n}{x\PYZus{}val}\PY{p}{)}\PY{p}{,} \PY{n}{y\PYZus{}val}\PY{p}{[}\PY{n}{bin\PYZus{}max}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: \textbf{Data from All rides} - Total rides:\{`Mon':
11286, `Tue': 10911, `Wed': 9604, `Thu': 10008, `Fri': 10741, `Sat':
9927, `Sun': 9654\} - Average rides:\{`Mon': 16.12, `Tue': 14.3, `Wed':
14.46, `Thu': 13.93, `Fri': 15.58, `Sat': 20.63, `Sun': 21.38\} -
\textbf{Mon} has higher rides among the entire list - \textbf{Sun} has
higher duration rides among the entire list

\textbf{Data from Subscriber rides} - Subscriber rides:\{`Mon': 8840,
`Tue': 9356, `Wed': 8447, `Thu': 8643, `Fri': 8648, `Sat': 5676, `Sun':
5372\} - Average rides:\{`Mon': 12.13, `Tue': 11.52, `Wed': 12.07,
`Thu': 11.48, `Fri': 11.72, `Sat': 13.18, `Sun': 13.23\} - \textbf{Tue}
has higher rides among the Subscriber list - \textbf{Sun} has higher
duration rides among the entire list

\textbf{Data from Customer rides} - Customer rides:\{`Mon': 2446, `Tue':
1555, `Wed': 1157, `Thu': 1365, `Fri': 2093, `Sat': 4251, `Sun': 4282\}
- Average rides:\{`Mon': 30.51, `Tue': 31.03, `Wed': 31.91, `Thu':
29.48, `Fri': 31.5, `Sat': 30.57, `Sun': 31.61\} - \textbf{Sun} has
higher rides among the Customer list - \textbf{Wed} has higher duration
rides among the entire list
...
{\color{incolor}In [{\color{incolor}47}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to continue to explore the dataset. \PYZsh{}\PYZsh{}}
         ...
         \PY{k}{def} \PY{n+nf}{trip\PYZus{}count\PYZus{}weekday\PYZus{}weekend}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{n}{ride\PYZus{}for}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    This function reads in a file with trip data and reports the sum of}
         \PY{l+s+sd}{    trip duration made during weekend and weekdays.}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 \PY{c+c1}{\PYZsh{} set up csv reader object}
                 \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                 ...
                 \PY{c+c1}{\PYZsh{} initialize count variables        }
                 \PY{n}{rides\PYZus{}mon}\PY{p}{,} \PY{n}{rides\PYZus{}tue}\PY{p}{,} \PY{n}{rides\PYZus{}wed}\PY{p}{,} \PY{n}{rides\PYZus{}thurs}\PY{p}{,} \PY{n}{rides\PYZus{}fri}\PY{p}{,} \PY{n}{rides\PYZus{}sat}\PY{p}{,} \PY{n}{rides\PYZus{}sun} \PY{o}{=} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}
                 \PY{n}{total\PYZus{}rides\PYZus{}list} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
         
                 
                 \PY{c+c1}{\PYZsh{} iterate through each row to get rides done during weekday/weekend}
                 \PY{c+c1}{\PYZsh{} initialize count variables        }
                 \PY{n}{rides\PYZus{}mon}\PY{p}{,} \PY{n}{rides\PYZus{}tue}\PY{p}{,} \PY{n}{rides\PYZus{}wed}\PY{p}{,} \PY{n}{rides\PYZus{}thurs}\PY{p}{,} \PY{n}{rides\PYZus{}fri}\PY{p}{,} \PY{n}{rides\PYZus{}sat}\PY{p}{,} \PY{n}{rides\PYZus{}sun} \PY{o}{=} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}
                 \PY{n}{d\PYZus{}rides\PYZus{}mon}\PY{p}{,} \PY{n}{d\PYZus{}rides\PYZus{}tue}\PY{p}{,} \PY{n}{d\PYZus{}rides\PYZus{}wed}\PY{p}{,} \PY{n}{d\PYZus{}rides\PYZus{}thurs}\PY{p}{,} \PY{n}{d\PYZus{}rides\PYZus{}fri}\PY{p}{,} \PY{n}{d\PYZus{}rides\PYZus{}sat}\PY{p}{,} \PY{n}{d\PYZus{}rides\PYZus{}sun} \PY{o}{=} \PY{l+m+mf}{0.0}\PY{p}{,} \PY{l+m+mf}{0.0}\PY{p}{,} \PY{l+m+mf}{0.0}\PY{p}{,} \PY{l+m+mf}{0.0}\PY{p}{,} \PY{l+m+mf}{0.0}\PY{p}{,} \PY{l+m+mf}{0.0}\PY{p}{,} \PY{l+m+mf}{0.0}
                 \PY{n}{total\PYZus{}rides\PYZus{}list} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
                 \PY{n}{average\PYZus{}ride\PYZus{}duration} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
                 
                 \PY{c+c1}{\PYZsh{} iterate through each row to get rides done during weekday/weekend}
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{n}{f\PYZus{}duration} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}0:.2f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{p}{)}
                     \PY{k}{if} \PY{n}{ride\PYZus{}for} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{All}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}                
                         \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Monday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{rides\PYZus{}mon} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                             \PY{n}{d\PYZus{}rides\PYZus{}mon} \PY{o}{+}\PY{o}{=} \PY{n}{f\PYZus{}duration}
                         \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tuesday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{rides\PYZus{}tue} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                             \PY{n}{d\PYZus{}rides\PYZus{}tue} \PY{o}{+}\PY{o}{=} \PY{n}{f\PYZus{}duration}
                         \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Wednesday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{rides\PYZus{}wed} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                             \PY{n}{d\PYZus{}rides\PYZus{}wed} \PY{o}{+}\PY{o}{=} \PY{n}{f\PYZus{}duration}
                         \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Thursday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{rides\PYZus{}thurs} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                             \PY{n}{d\PYZus{}rides\PYZus{}thurs} \PY{o}{+}\PY{o}{=} \PY{n}{f\PYZus{}duration}
                         \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Friday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{rides\PYZus{}fri} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                             \PY{n}{d\PYZus{}rides\PYZus{}fri} \PY{o}{+}\PY{o}{=} \PY{n}{f\PYZus{}duration}
                         \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Saturday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{rides\PYZus{}sat} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                             \PY{n}{d\PYZus{}rides\PYZus{}sat} \PY{o}{+}\PY{o}{=} \PY{n}{f\PYZus{}duration}
                         \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sunday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{rides\PYZus{}sun} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                             \PY{n}{d\PYZus{}rides\PYZus{}sun} \PY{o}{+}\PY{o}{=} \PY{n}{f\PYZus{}duration}
                     \PY{k}{elif} \PY{n}{ride\PYZus{}for} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}} \PY{o+ow}{and} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                         \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Monday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{rides\PYZus{}mon} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                             \PY{n}{d\PYZus{}rides\PYZus{}mon} \PY{o}{+}\PY{o}{=} \PY{n}{f\PYZus{}duration}
                         \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tuesday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                         ...
                         \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sunday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{rides\PYZus{}sun} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                             \PY{n}{d\PYZus{}rides\PYZus{}sun} \PY{o}{+}\PY{o}{=} \PY{n}{f\PYZus{}duration}
                     \PY{k}{elif} \PY{n}{ride\PYZus{}for} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}} \PY{o+ow}{and} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}                
                         \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Monday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                             \PY{n}{rides\PYZus{}mon} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                             \PY{n}{d\PYZus{}rides\PYZus{}mon} \PY{o}{+}\PY{o}{=} \PY{n}{f\PYZus{}duration}
                         \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tuesday}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 ...
                 \PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Mon}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=}  \PY{n}{rides\PYZus{}mon}
                 \PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tue}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=}  \PY{n}{rides\PYZus{}tue}
                 \PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Wed}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=}  \PY{n}{rides\PYZus{}wed}
                 \PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Thu}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=}  \PY{n}{rides\PYZus{}thurs}
                 \PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Fri}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=}  \PY{n}{rides\PYZus{}fri}
                 \PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sat}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=}  \PY{n}{rides\PYZus{}sat}
                 \PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sun}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=}  \PY{n}{rides\PYZus{}sun}
                 
                 \PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Mon}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=}  \PY{n+nb}{float}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}0:.2f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{d\PYZus{}rides\PYZus{}mon} \PY{o}{/} \PY{n}{rides\PYZus{}mon}\PY{p}{)}\PY{p}{)}
                 \PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tue}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=}  \PY{n+nb}{float}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}0:.2f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{d\PYZus{}rides\PYZus{}tue} \PY{o}{/} \PY{n}{rides\PYZus{}tue}\PY{p}{)}\PY{p}{)}
                 \PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Wed}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=}  \PY{n+nb}{float}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}0:.2f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{d\PYZus{}rides\PYZus{}wed} \PY{o}{/} \PY{n}{rides\PYZus{}wed}\PY{p}{)}\PY{p}{)}
                 \PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Thu}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=}  \PY{n+nb}{float}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}0:.2f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{d\PYZus{}rides\PYZus{}thurs} \PY{o}{/} \PY{n}{rides\PYZus{}thurs}\PY{p}{)}\PY{p}{)}
                 \PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Fri}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=}  \PY{n+nb}{float}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}0:.2f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{d\PYZus{}rides\PYZus{}fri} \PY{o}{/} \PY{n}{rides\PYZus{}fri}\PY{p}{)}\PY{p}{)}
                 \PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sat}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=}  \PY{n+nb}{float}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}0:.2f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{d\PYZus{}rides\PYZus{}sat} \PY{o}{/} \PY{n}{rides\PYZus{}sat}\PY{p}{)}\PY{p}{)}
                 \PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Sun}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=}  \PY{n+nb}{float}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}0:.2f\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{d\PYZus{}rides\PYZus{}sun} \PY{o}{/} \PY{n}{rides\PYZus{}sun}\PY{p}{)}\PY{p}{)}
                 \PY{c+c1}{\PYZsh{} return as a tuple}
                 \PY{k}{return}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{,} \PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}48}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np}
         ...
         \PY{n}{trip\PYZus{}city\PYZus{}time} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{\PYZcb{}}\PY{p}{\PYZcb{}}
         \PY{c+c1}{\PYZsh{} get subscriber and customer trip data and plot to hist}
         \PY{k}{for} \PY{n}{time\PYZus{}city}\PY{p}{,} \PY{n}{time\PYZus{}filenames} \PY{o+ow}{in} \PY{n}{trip\PYZus{}city\PYZus{}time}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}    
             \PY{c+c1}{\PYZsh{}get list of total rides for each day and plot }
             \PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{,} \PY{n}{average\PYZus{}ride\PYZus{}duration} \PY{o}{=} \PY{n}{trip\PYZus{}count\PYZus{}weekday\PYZus{}weekend}\PY{p}{(}\PY{n}{time\PYZus{}filenames}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{All}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Total rides:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{)}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Average rides:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of All rides by days for }\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{n}{time\PYZus{}city}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{n+nb}{list}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{n+nb}{list}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{o}{.}\PY{n}{keys}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ has higher rides among the entire list}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n+nb}{max}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{,} \PY{n}{key}\PY{o}{=}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{o}{.}\PY{n}{get}\PY{p}{)}\PY{p}{)}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ has higher duration rides among the entire list}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n+nb}{max}\PY{p}{(}\PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{p}{,} \PY{n}{key}\PY{o}{=}\PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{o}{.}\PY{n}{get}\PY{p}{)}\PY{p}{)}\PY{p}{)}
             
                 
             
             \PY{c+c1}{\PYZsh{}get list of subscriber rides for each day and plot    }
             \PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{,} \PY{n}{average\PYZus{}ride\PYZus{}duration} \PY{o}{=} \PY{n}{trip\PYZus{}count\PYZus{}weekday\PYZus{}weekend}\PY{p}{(}\PY{n}{time\PYZus{}filenames}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber rides:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{)}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Average rides:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Subscriber rides by days for }\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{n}{time\PYZus{}city}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{n+nb}{list}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{n+nb}{list}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{o}{.}\PY{n}{keys}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ has higher rides among the Subscriber list}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n+nb}{max}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{,} \PY{n}{key}\PY{o}{=}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{o}{.}\PY{n}{get}\PY{p}{)}\PY{p}{)}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ has higher duration rides among the entire list}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n+nb}{max}\PY{p}{(}\PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{p}{,} \PY{n}{key}\PY{o}{=}\PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{o}{.}\PY{n}{get}\PY{p}{)}\PY{p}{)}\PY{p}{)}
             
             \PY{c+c1}{\PYZsh{}get list of customer rides for each day and plot }
             \PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{,} \PY{n}{average\PYZus{}ride\PYZus{}duration} \PY{o}{=} \PY{n}{trip\PYZus{}count\PYZus{}weekday\PYZus{}weekend}\PY{p}{(}\PY{n}{time\PYZus{}filenames}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{in\PYZus{}file}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer rides:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{)}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Average rides:}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Customer rides by days for }\PY{l+s+s1}{\PYZsq{}} \PY{o}{+} \PY{n}{time\PYZus{}city}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{n+nb}{list}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{xticks}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{n+nb}{list}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{o}{.}\PY{n}{keys}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ has higher rides among the Customer list}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n+nb}{max}\PY{p}{(}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{p}{,} \PY{n}{key}\PY{o}{=}\PY{n}{total\PYZus{}rides\PYZus{}list}\PY{o}{.}\PY{n}{get}\PY{p}{)}\PY{p}{)}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{ has higher duration rides among the entire list}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n+nb}{max}\PY{p}{(}\PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{p}{,} \PY{n}{key}\PY{o}{=}\PY{n}{average\PYZus{}ride\PYZus{}duration}\PY{o}{.}\PY{n}{get}\PY{p}{)}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
\textbf{Brand value analysis based on social media data}

Crawl through social media pages of any particular brand in Twitter,
Facebook etc.,. Capture the post tagged with brand name. Define list of
words with good, average, bad categories. For eg. - Good : very good
service, excellent, helpful etc., - Average : Is ok, was OK, can be
better, satisfactory etc., - Bad : worst, bad, no response, need
improvement etc.,

Clean up the data captured by the crawler. Analyze the data based on
above categories. Based on the results brands can visualize how reputed
the brand is among the people in social media
